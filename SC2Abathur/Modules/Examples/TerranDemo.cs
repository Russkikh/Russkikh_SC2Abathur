...
namespace SC2Abathur.Modules.Examples
{
    ...
    public class TerranDemo : IReplaceableModule
    {
        ...
        public void OnStart()
        {
            ...
            _intelManager.Handler.RegisterHandler(Case.WorkerAddedSelf, WorkerCreationHandler);
            //_intelManager.Handler.RegisterHandler(Case.WorkerAddedSelf, FromVespenToMinerals);
            ...
            allWorkers = _squadRep.Create("AllWorkers");
        ...
        public void OnStep()
        {
            ...
            if (!_intelManager.ProductionQueue.Any())
            {
                ...
                //_productionManager.QueueUnit(BlizzardConstants.Unit.Barracks, lowPriority: false, spacing: 2);
        ...
        public void VespenWorkesrsToMine()
        {
            var vespeners = _intelManager.WorkersSelf();
        ...
        public void WorkerCreationHandler(IUnit u)
            => allWorkers.AddUnit(u);

        //public void FromVespenToMinerals(IUnit u)
        //{
        //    if (allWorkers.Units.Count == 10)
        //    {
        //        _intelManager. ;
        //        //allWorkers
        //    }
        ...
        public void QueueRaxRush()
        {
            ...
            ///_productionManager.QueueUnit(BlizzardConstants.Unit.TechLab, lowPriority: false);
            _productionManager.QueueUnit(BlizzardConstants.Unit.BarracksTechLab, lowPriority: false);


            ///_productionManager.QueueTech(BlizzardConstants.Research.GroundWeapons1, lowPriority: false);
            ...
            _productionManager.QueueUnit(BlizzardConstants.Unit.Barracks, lowPriority: false, spacing: 2);
            //_intelManager.WorkersSelf().toMinerals???
            ...
            // we are building engineering bay and upgrade Armor and Weapon
            _productionManager.QueueUnit(BlizzardConstants.Unit.EngineeringBay, lowPriority: false);
            _productionManager.QueueTech(BlizzardConstants.Research.InfantryArmor1, lowPriority: false);
            _productionManager.QueueTech(BlizzardConstants.Research.InfantryWeapons1, lowPriority: false);
        }
    }
}