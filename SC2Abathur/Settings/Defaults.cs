...
namespace SC2Abathur.Settings
{
    ...
    public static class Defaults {
        ...
        public static GameSettings GameSettings => new GameSettings {
                ...
                FolderPath = @"D:\Games\StarCraft II",
                ...
                Realtime = false,
                DisableFog = false,
                ParticipantRace = Race.Zerg,
                Opponents = new Collection<PlayerSetup> { new PlayerSetup { Type = PlayerType.Computer, Race = Race.Terran, Difficulty = Difficulty.Medium } }
            };
    }
}
